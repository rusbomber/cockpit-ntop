...
<template  v-for="instance in instances" >
	<CentoConf :name="instance.name" :mode="instance.mode" :label="instance.label" v-if="tab == instance.name" />
</template>
...
import CentoConf from './CentoConf.vue'
import Modal from './Modal.vue'
import LicenseConf from './LicenseConf.vue'

const toast = useToast();

const productName = ref("cento")
const productLabel = ref("Cento")
